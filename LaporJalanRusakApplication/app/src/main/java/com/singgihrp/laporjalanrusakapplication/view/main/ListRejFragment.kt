...
import com.singgihrp.laporjalanrusakapplication.databinding.FragmentListRejBinding
...
class ListRejFragment : Fragment(), View.OnClickListener {
    private var _binding : FragmentListRejBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentListRejBinding.inflate(inflater, container, false)
    ...
    private fun showItem() {
        homeViewModel.getRejReport().observe(viewLifecycleOwner){event->
                    ...
                    Status.SUCCESS -> {
                        ...
                        adapter.setOnItemClickListener(object : CurrentReportAdapter.OnItemClickListener{
                            override fun onItemClick(position: Int) {
                                ...
                                findNavController().navigate(R.id.action_listRejFragment_to_detailReportFragment, bundle)
                            }
                        })
                    }
                    Status.ERROR -> {
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            R.id.img_arrowback -> {
                findNavController().navigate(R.id.action_listRejFragment_to_homeFragment)
            }
        }
    }
