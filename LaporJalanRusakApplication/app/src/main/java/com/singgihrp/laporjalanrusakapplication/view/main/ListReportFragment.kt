...
import com.singgihrp.laporjalanrusakapplication.databinding.FragmentListReportBinding
...
class ListReportFragment : Fragment(), View.OnClickListener {
    ...
    private fun showList(){
        homeViewModel.getCurrentReports().observe(viewLifecycleOwner){event->
                    ...
                    Status.SUCCESS -> {
                        ...
                        adapter.setOnItemClickListener(object : CurrentReportAdapter.OnItemClickListener{
                            override fun onItemClick(position: Int) {
                                ...
                                findNavController().navigate(R.id.action_listReportFragment_to_detailReportFragment, bundle)
                            }
                        })
                    }
                    Status.ERROR -> {
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            R.id.img_arrowback -> {
                findNavController().navigate(R.id.action_listReportFragment_to_homeFragment)
            }
        }
    }
