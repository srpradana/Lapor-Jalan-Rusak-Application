...
import com.singgihrp.adminljr.databinding.FragmentListReportAccBinding
...
class ListReportAccFragment : Fragment() {
    ...
    private fun showList() {
        listReportViewModel.getAccReport().observe(viewLifecycleOwner) { event ->
